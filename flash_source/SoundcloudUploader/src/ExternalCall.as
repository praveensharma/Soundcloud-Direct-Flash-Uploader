package {
	...
	internal class ExternalCall
	{
		...
		public static function UploadComplete(callback:String, file_object:Object, streamURL:String, downloadURL:String, soundcloudID:String):void {
			
			ExternalInterface.call(callback, EscapeMessage(file_object), streamURL, downloadURL, soundcloudID);
